...
class _GamePageState extends State<GamePage> {
  ...
  Future<void> submitAnswer() async {
    ...
    final correct = evalToPercent(currentQuestion!.evalCp);
  ...
  Widget build(BuildContext context) {
    ...
    final turnText = currentQuestion!.sideToMoveAfter == 'black' ? '次の手番：先手' : '次の手番：後手';
    final turnColor = currentQuestion!.sideToMoveAfter == 'black' ? const Color(0xFF1F6FD1) : const Color(0xFFD73737);
            ...
            Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      SizedBox(width: 220, child: Text(turnText, style: GoogleFonts.notoSerifJp(color: turnColor, fontSize: 20, fontWeight: FontWeight.w900))),
                      Expanded(child: Center(child: LifePieces(lives: lives, previousLives: previousLives))),
                      SizedBox(width: 220, child: Align(alignment: Alignment.centerRight, child: TimerView(remainingTenths: remainingTenths, overTime: overTime, overtimeSeconds: overtimeSeconds))),
                    ],
                  ),
                ),
                Expanded(
