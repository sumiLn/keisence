...
class _ResultPageState extends State<ResultPage> {
  ...
  void movePage(int delta) {
    if (pageMoving || widget.records.isEmpty) return;
    final next = (selected + delta).clamp(0, widget.records.length - 1);
                ...
                if (records.isNotEmpty)
                  Expanded(
                    child: GestureDetector(
                      ...
                      onHorizontalDragEnd: (_) => dragAccum = 0,
                      onHorizontalDragCancel: () => dragAccum = 0,
