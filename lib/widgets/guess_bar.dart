  ...
  Widget build(BuildContext context) {
    return Opacity(
      ...
      child: LayoutBuilder(builder: (context, constraints) {
        ...
        final x = 36 + width * (widget.percent / 100);
        ...
        return GestureDetector(
          onPanUpdate: widget.enabled
              ? (details) {
                  ...
                  final newLift = min(0.0, local.dy - 78);
          ...
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        const Positioned(left: 0, top: 32, child: Text('-3000〜', style: TextStyle(fontSize: 12))),
                        Positioned(left: width * (1 / 3) - 18, top: 32, child: const Text('-1000', style: TextStyle(fontSize: 12))),
                        Positioned(left: width * 0.5 - 4, top: 32, child: const Text('0', style: TextStyle(fontSize: 12))),
                        Positioned(left: width * (2 / 3) - 18, top: 32, child: const Text('+1000', style: TextStyle(fontSize: 12))),
                        Positioned(right: 0, top: 32, child: const Text('+3000〜', style: TextStyle(fontSize: 12))),
                      ],
                    ),
                  ),
                ),
                ...
                const Positioned(top: 124, left: 36, child: Text('後手有利')),
                const Positioned(top: 124, right: 36, child: Text('先手有利')),
                Positioned(top: 6, child: Text('${widget.percent.round()}%', style: const TextStyle(fontSize: 30, fontWeight: FontWeight.bold))),
                Positioned(
                  left: x - 46,
                  top: 30 + widget.lift,
                  child: AnimatedScale(
                ...
                if (lifted) const Positioned(bottom: 3, child: Text('指を離して決定', style: TextStyle(color: Colors.amber, fontSize: 18))),
              ],
            ),
          ),
        );
