    ...
    return Opacity(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final correctX =
              safeCorrect == null ? null : 36 + width * (safeCorrect / 100);
          ...
          return GestureDetector(
            onPanUpdate: widget.enabled
                ? (details) {
                    ...
                    final rawPercent =
                        (((local.dx - 36) / width) * 100).clamp(0.0, 100.0);

                    if (newLift < -25 && lockedPercent == null) {
                      lockedPercent = widget.percent;
                    }
                    if (newLift > -12) {
                      lockedPercent = null;
                    }
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: const [
                            BoxShadow(
                                blurRadius: 12, color: Colors.greenAccent),
                          ],
                        ),
                      ),
                    ),
                  const Positioned(top: 122, left: 36, child: Text('後手有利')),
                  const Positioned(top: 122, right: 36, child: Text('先手有利')),
                  Positioned(
                    top: 8,
                    child: Text(
                  ...
                  Positioned(
                    ...
                    child: AnimatedScale(
                      ...
                      child: SizedBox(
                        width: 92,
                        height: 101,
                        child: Image.asset('assets/pieces/O.png',
                            fit: BoxFit.contain),
                      ),
                    ),
                  ),
